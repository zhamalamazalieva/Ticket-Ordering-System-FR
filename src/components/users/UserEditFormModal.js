                    ...
                    >
                        <CForm onSubmit={handleSubmit}>
                                        ...
                                        <CFormGroup row>
                                            ...
                                            <CCol xs="12">
                                                <CInput
                                                    ...
                                                    onChange={handleChange}
                                                    onBlur={handleBlur}
                                                    className={( errors.first_name && touched.first_name) ? 'border-error' : '' }
                                                />
                                        ...
                                        <CFormGroup row>
                                            ...
                                            <CCol xs="12">
                                                <CInput
                                                    ...
                                                    onChange={handleChange}
                                                    onBlur={handleBlur}
                                                    className={( errors.last_name && touched.last_name) ? 'border-error' : '' }
                                                />
                            ...
                            <CModalFooter className="d-flex justify-content-between">
                                ...
                                <div>
                                    { isLoading ? <span className="mr-5"><MiniSpinner/></span>
                                    :
